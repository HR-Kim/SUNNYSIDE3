...
private final static Logger LOG = LoggerFactory.getLogger(LHJ_BoxofficeWebTest.class);
	...
	@Autowired
	LHJ_ScreeningSvcImpl screeningSvcImpl;
	...
	public void do_selectOne() throws Exception {
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.get("/screening/do_selectOne.do")
	...
	@Test
	@Ignore
	public void do_update_screenUp() throws Exception {
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.post("/screening/do_update_screenUp.do")
				.param("movieId", "F48336");
	...
	/** 최신개봉으로 상태 변경(상영중으로 상태 변경)(010) */
	private void do_update_screenUp(LHJ_MovieVO inVO) throws Exception {
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.post("/screening/do_update_screenUp.do")
	...
	@Test
	@Ignore
	public void do_update_screenDown() throws Exception {
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.post("/screening/do_update_screenDown.do")
																			.param("movieId", "F48336");
	...
	/** 비 상영상태로 상태 변경(000)*/
	private void do_update_screenDown(LHJ_MovieVO inVO) throws Exception {
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.post("/screening/do_update_screenDown.do")
																			.param("movieId", inVO.getMovieId());
