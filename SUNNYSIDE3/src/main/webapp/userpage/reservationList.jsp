...
<body>
		...
		<table class="table table-striped table-bordered table-hover" id="reservationTable">
		<h3>상품 결제 내역</h3>
		<thead  class="bg-default" style="background-color: #333333; color: #f0f0f0">
				<tr>
			
					<th class="text-center col-md-2 col-xs-2">상품이름</th>
					<th class="text-center col-md-3 col-xs-5">결제번호</th>					
					<th class="text-center col-md-2 col-xs-2">결제 금액</th>
