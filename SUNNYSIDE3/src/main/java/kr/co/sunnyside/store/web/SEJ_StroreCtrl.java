...
//	  SEJ_StroreVO store;
	  ...
	  //view
	    ...
	    * @return
	    */
	   @RequestMapping(value="store/do_imageUpload.do", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
	   @ResponseBody //이거 없으면 json으로 안나옴
	   public String do_imageUpload(MultipartHttpServletRequest mReg) throws IllegalStateException, IOException{ 
		    LOG.debug("==========================");
