...
public class StringUtil_N {
	private static Logger LOG = LoggerFactory.getLogger(StringUtil.class);
	
	// File Root 디렉토리
	public static final String IMAGE_ROOT = "C:\\Users\\sist\\git\\SUNNYSIDE3\\SUNNYSIDE3\\src\\main\\webapp\\resources\\img\\phototicket";
	...
	public static String dynamicDir() {
		...
		LOG.debug("=mm=" + mm);
		String datePath = IMAGE_ROOT + File.separator + yyyy + File.separator + mm;
	 ...
	 */
	public static SEJ_FileVO  fileRename(File f) {
		String retFileNm = "";
		// 01.파일 존재 Check
		if (!f.exists()) {
			SEJ_FileVO outVO=new SEJ_FileVO(0,null, f.getAbsolutePath());
			return outVO;
		}
		...
		SEJ_FileVO outVO=new SEJ_FileVO(count,body,f.getAbsolutePath());
